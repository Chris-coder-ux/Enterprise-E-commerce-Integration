 ...
 *
 * Esta clase maneja la interfaz de administración para la gestión de certificados SSL,
 * incluyendo configuración, rotación automática, caché y diagnósticos.
 *
 * @since 1.0.0
 * @package    MiIntegracionApi
 * @subpackage MiIntegracionApi/Admin
...
class SSLCertificatesManager {
    ...
    /**
     * Instancia del gestor de configuración SSL
     *
     * @since 1.0.0
    ...
    /**
     * Instancia del gestor de rotación de certificados
     *
     * @since 1.0.0
     ...
     *
     * Inicializa todas las dependencias y registra los hooks necesarios
     * para la administración de certificados SSL.
     *
     * @since 1.0.0
     */
    public function __construct() {
        ...
        if (!$this->api_connector) {
            throw new \Exception('No se pudo obtener ApiConnector centralizado');
        }
    ...
    /**
     * Añade el menú de administración SSL al panel de WordPress
     *
     * Este método está comentado para evitar menús duplicados.
     * Se debe llamar desde el controlador principal del plugin.
     *
     * @since 1.0.0
     * @return void
     */
    ...
    /**
     * Registra y encola scripts y estilos para la página de administración SSL
     *
     * Solo se cargan en la página específica de administración SSL
    ...
    /**
     * Registra las configuraciones SSL en WordPress
     *
     * Registra todas las opciones de configuración SSL que se pueden
     * gestionar desde el panel de administración.
     *
     * @since 1.0.0
     * @return void
     */
    ...
    /**
     * Maneja la rotación manual de certificados desde el panel de administración
     *
     * Procesa la solicitud de rotación de certificados, verificando permisos
     * y nonces de seguridad antes de ejecutar la operación.
     *
     * @since 1.0.0
     * @return void Redirige de vuelta a la página de administración
     */
    ...
    /**
     * Maneja la limpieza manual de caché de certificados
     *
     * Procesa la solicitud de limpieza de caché, verificando permisos
     * y seguridad antes de ejecutar la operación.
     *
     * @since 1.0.0
     * @return void Redirige de vuelta a la página de administración
     */
    ...
    /**
     * Maneja la corrección de permisos de certificados
     *
     * Procesa la solicitud de corrección de permisos, verificando
     * autorización antes de ejecutar la operación.
     *
     * @since 1.0.0
     * @return void Redirige de vuelta a la página de administración
     */
    ...
    /**
     * Maneja la actualización de configuración SSL desde el formulario
     *
     * Procesa todos los datos del formulario de configuración SSL,
     * incluyendo opciones básicas, rotación y timeouts.
     *
     * @since 1.0.0
     * @return void Redirige de vuelta a la página de administración
     */
    ...
    /**
     * Renderiza la página principal de administración SSL
     *
     * Genera toda la interfaz de usuario para la gestión de certificados SSL,
     * incluyendo pestañas para estado, configuración, herramientas, etc.
     *
     * @since 1.0.0
     * @return void Imprime el HTML de la página de administración
     */
     ...
     *
     * Convierte un valor numérico de bytes a una cadena formateada
     * con las unidades apropiadas (B, KB, MB, GB, TB).
     *
     * @since 1.0.0
     * @param int $bytes El tamaño en bytes a formatear
     * @param int $precision Número de decimales a mostrar (por defecto 2)
     * @return string El tamaño formateado con unidades
     */
