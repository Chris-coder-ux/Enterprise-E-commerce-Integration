...
class BackupAutoloader {
    ...
    private $critical_classes = [
        ...
        'MiIntegracionApi\\Core\\CacheConfig' => 'includes/Core/CacheConfig.php',
    ...
    public static function init() {
        if (self::$instance === null) {
            ...
            spl_autoload_register([self::$instance, 'autoload'], true, false);
            			...
            			// Log de registro exitoso (solo primera vez)
			if (defined('WP_DEBUG') && constant('WP_DEBUG') && get_option('mi_backup_autoloader_registered', false) === false) {
				error_log('Mi Integración API: Autoloader de respaldo registrado correctamente');
				update_option('mi_backup_autoloader_registered', true, false);
			}
        }
