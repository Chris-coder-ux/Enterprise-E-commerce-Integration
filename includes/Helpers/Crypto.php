 ...
 *
 * Proporciona métodos para cifrar y descifrar credenciales de la API usando AES-256-CBC,
 * así como funciones de compatibilidad para código legado.
 *
 ...
 *
 * Contiene métodos para cifrar y descifrar credenciales de la API, y funciones de compatibilidad.
 */
class Crypto {
     ...
     * @param string|null $password   Contraseña para cifrar (usa AUTH_KEY si no se proporciona).
     * @return string Texto cifrado en formato base64.
     */
    public static function encrypt_api_secret(string $plain_text, ?string $password = null): string {
     ...
     * @param string|null $password   Contraseña para descifrar (usa AUTH_KEY si no se proporciona).
     * @return string|false Texto descifrado o false si falla la verificación de integridad.
     */
    public static function decrypt_api_secret(string $ciphertext, ?string $password = null): string|false {
        $password           = $password ?: AUTH_KEY;
     ...
     *
     * @param string      $plain_text Texto a cifrar.
     * @param string|null $password   Contraseña para cifrar (opcional).
     * @return string Texto cifrado en formato base64.
     */
    public static function mia_encrypt_api_secret(string $plain_text, ?string $password = null): string {
     ...
     *
     * @param string      $ciphertext Texto cifrado en formato base64.
     * @param string|null $password   Contraseña para descifrar (opcional).
     * @return string|false Texto descifrado o false si falla la verificación de integridad.
     */
    public static function mia_decrypt_api_secret(string $ciphertext, ?string $password = null): string|false {
