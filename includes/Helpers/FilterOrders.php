...
class FilterOrders {
	 ...
	 *   - status (string|array): Estado(s) del pedido.
	 *   - min_total (float): Importe mínimo.
	 *   - max_total (float): Importe máximo.
	 *   - date_after (string): Fecha mínima (Y-m-d).
	 *   - date_before (string): Fecha máxima (Y-m-d).
