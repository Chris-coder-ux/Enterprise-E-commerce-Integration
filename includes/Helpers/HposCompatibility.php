 ...
 *
 * Proporciona métodos para verificar compatibilidad y estado de HPOS en WooCommerce,
 * mostrando avisos y delegando en la clase oficial del nuevo namespace.
 *
 * @deprecated 2.0.0 Usar MiIntegracionApi\WooCommerce\HposCompatibility en su lugar.
 * @package MiIntegracionApi\Helpers
 */
class HposCompatibility {
	/**
	 * Verifica si el plugin es compatible con la configuración actual de WooCommerce y HPOS.
	 *
	 * Muestra aviso informativo y registra el uso de HPOS si está activo.
	 *
	...
	/**
	 * Muestra un aviso en el admin cuando HPOS está habilitado.
	 *
	 * @return void
	 */
	 ...
	 *
	 * Usa la clase oficial si está disponible, o verifica por métodos alternativos.
	 *
