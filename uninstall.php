...
// Eliminar opciones del plugin (excepto URL y sesión que ahora son fijas)
$options_to_delete = [
    'mia_sync_clientes_enabled',
...
$cache_prefixes_to_clean = [
    ...
    'mia_agentes_', 'mia_formas_envio_',
    // Transients de sincronización (actualizados con nuevos patrones)
    'mia_sync_progress', 'mia_sync_start_time', 'mia_sync_current_batch_', 'mia_sync_batch_',
    'mia_sync_current_product_', 'mia_sync_last_product_', 'mia_sync_processed_skus',
    'mia_sync_completed_batches', 'mia_sync_cancelada', 'mi_integracion_api_sync_',
    'mia_sync_heartbeat', 'mia_sync_lock_', 'mia_sync_metrics_'
];
